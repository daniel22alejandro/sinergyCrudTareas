function obtenerTareas() {
    ...
    fetch('http://localhost/sinergyCrudTareas/tareas/tareas')
        .then(response => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('crearTareaForm').addEventListener('submit', function(event) {
        ...
        fetch('http://localhost/sinergyCrudTareas/tareas/agregarTarea', {
            method: 'POST',
            headers: {
    ...
    document.getElementById('editarTareaForm').addEventListener('submit', function(event) {
        ...
        fetch(`http://localhost/sinergyCrudTareas/tareas/actualizarTarea/${id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
...
function editarTarea(id) {
    fetch(`http://localhost/sinergyCrudTareas/tareas/tarea/${id}`)
        .then(response => response.json())
        .then(data => {
            if (data.status) {
...
function eliminarTarea(id) {
    fetch(`http://localhost/sinergyCrudTareas/tareas/eliminarTarea/${id}`, {
        method: 'DELETE'
    })
        .then(response => response.json())
        .then(data => {
...
function marcarTareas(completado) {
    ...
    fetch('http://localhost/sinergyCrudTareas/tareas/marcarTareas', {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
